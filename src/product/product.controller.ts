...
export class ProductController {
    ...
    @Get('getAllProductsForShopAndCategory/:id_shop/:category')
    @ApiOperation({summary: 'Retorna todos os produtos da loja e categoria selecionadas.'})
    async getAllProductsForShopAndCategoryController(@Param('id_shop') id_shop: number, @Param('category') category:string) {
        return await this.productService.getAllProductsForShopAndCategory(id_shop=id_shop, category=category);
    }

    @Get('getAllProductsForShop/:id_shop')
    @ApiOperation({summary: 'Retorna todos os produtos da loja selecionado.'})
    async getAllProductsForShopController(@Param('id_shop') id_shop: number) {
